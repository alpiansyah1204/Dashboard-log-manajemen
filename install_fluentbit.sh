...
[OUTPUT]
    ...
    Labels      job=${JOB},host=${HOST_NAME},os=${OS_NAME},environment=${ENVIRONMENT},app_group=${APP_GROUP},server_role=${SERVER_ROLE},site=${SITE},source=systemd
    Line_Format json
...
[OUTPUT]
    ...
    Labels      job=${JOB},host=${HOST_NAME},os=${OS_NAME},environment=${ENVIRONMENT},app_group=${APP_GROUP},server_role=${SERVER_ROLE},site=${SITE},source=dnf
    Line_Format json
...
#     URI         ${LOKI_URI}
#
#     Labels      job=${JOB},host=${HOST_NAME},os=${OS_NAME},environment=${ENVIRONMENT},app_group=${APP_GROUP},server_role=${SERVER_ROLE},site=${SITE},source=messages
#     Line_Format json
...
#     URI         ${LOKI_URI}
#
#     Labels      job=${JOB},host=${HOST_NAME},os=${OS_NAME},environment=${ENVIRONMENT},app_group=${APP_GROUP},server_role=${SERVER_ROLE},site=${SITE},source=cron
#     Line_Format json
...
#     URI         ${LOKI_URI}
#
#     Labels      job=${JOB},host=${HOST_NAME},os=${OS_NAME},environment=${ENVIRONMENT},app_group=${APP_GROUP},server_role=${SERVER_ROLE},site=${SITE},source=boot
#     Line_Format json
EOF
